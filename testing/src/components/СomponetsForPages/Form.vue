...
<template>
    ...
    border-black rounded-5 p-4 mx-5 my-1">
        ...
        <input type="text" class="p-4 rounded-4 text-black bg-white border border-black" placeholder="Имя" v-model="username">
        <input type="tel" class="p-4 rounded-4 text-black bg-white border border-black" placeholder="Номер телефона" v-model="phone">
        <input type="email" class="p-4 rounded-4 text-black bg-white border border-black" placeholder="Email" v-model="email">
        <textarea type="text" class="p-3 rounded-4 text-black bg-white border border-black" placeholder="Ваше сообщение/предложение" v-model="message"></textarea>
